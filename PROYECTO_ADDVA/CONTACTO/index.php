    ...
    <header class="navegacion">
        ...
        <nav class="navv">     
            <ul class="navigation">
                ...
                <li><a href="#Que servicios ofrecemos">¿Que servicios ofrecemos</a></li>
                <li><a href="#Vender Auto">Precuntas Frecuentes</a></li>
                <li><a href="#Buscar profesionales">Contactanos</a></li>
            </ul>
        </nav>
        <div class="InfoButton">
            <button id="infobutton">¡Solicitar Informacion!</button>
        </div>

    </header>
        <main class="container">
<img id="imgcont" src="./imgcontacto.png" alt="">
        </main>
...
<div class="formcontacto">
    ...
    <form id="form"  method="post" action="registrar.php">
        <input type="Name" id="Nombre" name="name" placeholder="Tu Nombre">
        <input type="lastname" id="apellido" name="lastname" placeholder="Tu Apellido">
        <input type="Email" id="Email" name="email" placeholder="Tu Correo">
        <input type="Phone" id="Movil" name="phone" placeholder="Tu telefono">
