...
$usuario = "u386304798_addva";
$contrasena = "Granyosoy7";
$base_de_datos = "u386304798_usuarios";
...
if (isset($_POST['register'])) {
    if (
        ...
        $consulta = "INSERT INTO datos(nombre, apellido, email, telefono, mensaje, fecha) VALUES(?, ?, ?, ?, ?, ?)";
...
<div class="sidebar">
    ...
    <ul class="sidebar-links">
        ...
        <a id="infobutton" href="http://localhost/PROYECTO_ADDVA/CONTACTO/index.php">¡Solicitar Informacion!</a>
            ...
            <a class="back" href="http://localhost/PROYECTO_ADDVA/HOME/index.php">Volver al Inicio</a>
            </div>
    </section>
    <footer class="fotter">
...
// Cerrar la conexión al final del script o donde ya no sea necesaria
mysqli_close($conex);
?>
